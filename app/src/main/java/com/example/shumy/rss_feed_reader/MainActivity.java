...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listApps = findViewById(R.id.feedListView);
...
//            Log.d(TAG, "onPostExecute: parameter is " + s);
            ParseXML parseApplications = new ParseXML();
            parseApplications.parse(s);
            FeedAdapter feedAdapter = new FeedAdapter(MainActivity.this, R.layout.item_detail,parseApplications.getApplications());
